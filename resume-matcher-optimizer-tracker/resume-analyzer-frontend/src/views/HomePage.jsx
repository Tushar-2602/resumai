...
import { Cpu, ShieldCheck, Bot, Cloud } from "lucide-react";
...
>
 <h1 className="text-4xl md:text-5xl font-extrabold text-green-900 mb-4 leading-tight">
  ...
  <p className="text-xl text-gray-800 mb-10 leading-relaxed">
    Optimize resumes with real-time AI scoring. Match talent to roles. Empower hiring through AI.
  </p>
  ...
  <div className="space-y-10">
    ...
    >
      ...
      <div>
        ...
        <p className="text-base text-gray-700">
          Powered by <strong>FastAPI</strong>, secure <strong>JWT authentication</strong>, and <strong>MYSQL</strong> for data storage.
        </p>
      </div>
    </motion.div>
    ...
    >
      ...
      <div>
        <h3 className="text-2xl font-semibold text-green-800 mb-1">AI engine and vector DB</h3>
        <p className="text-base text-gray-700">
          Uses <strong>gemini-2.5-flash</strong>, <strong>gemini-embedding-001</strong>, <strong>Langchain</strong>, and <strong>Pinecone</strong> for intelligent resume matching.
        </p>
      </div>
    </motion.div>
    ...
    >
      ...
      <div>
        ...
        <p className="text-base text-gray-700">
          Resume PDF parsing, <strong>Vector DB support</strong>, <strong>AWS S3</strong> document storage, and real-time scoring visuals.
        </p>
      </div>
    </motion.div>
  </div>
      ...
      >
        <div className="w-full max-w-sm text-center">
          ...
          <button
            ...
            className="w-full bg-white text-green-800 border-2 border-green-800 py-3 rounded-xl font-semibold shadow-md hover:bg-green-50 transition-all"
          >
            I am Hiring
          </button>
        </div>
